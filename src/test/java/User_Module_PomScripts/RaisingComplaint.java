...
import com.HRA.ObjectRepository.Details_UpdatePage;
import com.HRA.ObjectRepository.HomePage;
import com.HRA.ObjectRepository.LoginPage;
import com.HRA.ObjectRepository.UserComplaintsPage;
...
//		driver.findElement(By.name("login")).click();
	...
	/* Click on details or update link */
	userDP.updDetLnk();
	/*creates the object of Details_UpdatePage*/
	Details_UpdatePage detUpdPage = new Details_UpdatePage(driver);
	/* Click on Complaint button */
	detUpdPage.complaintBtn();
	/*creates the object of UserComplaintsPage*/
	UserComplaintsPage userCP = new UserComplaintsPage(driver);
	/*Fetches the data from excel*/
	userCP.UserComplaint(eLib.getList(driver, "raising_complaint", 0, 0, 1), driver);
	/* Click on Submit button */
	userCP.ClickOnSubmitBtn();
	/* User should logout */
	lP.logoutBtn();
	...
	/* Click on Complaint list link */
	adminDP.ComplaintlistLnk();
	/* Admin should logout */
	lP.logoutBtn();
